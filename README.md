...
As of now this is complete executable code in the following environment. No need to add any external jars. All libraries are with reference to Jdeveloper libraries. 
